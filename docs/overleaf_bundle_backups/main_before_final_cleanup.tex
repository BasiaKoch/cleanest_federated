...
partial updates instead of correcting them. We report this as an observed
failure mode --- its precise cause is not isolated here and is left to future
work --- so FedNova is best read as regime-dependent rather than universally
...
symmetric L4 multi-seed node-pinned ($+0.005$), Li-style four-condition
...
Figure~\ref{fig:l4-confusion-appendix} (Appendix~\ref{app:repro}).
...
% =============================================================================
% Figure 5.7 -- cross-experiment per-class FedProx-vs-FedAvg F1 differences
% =============================================================================

\begin{figure}[H]
\centering
\includegraphics[width=\textwidth]{F_cross_experiment_per_class.pdf}
\caption{Cross-experiment synthesis: per-class FedProx$-$FedAvg (or
...
results. The single rule it encodes is that rare-class performance is preserved
when rare-client signal reaches the global model. Each cell records the observed
outcome for an optimiser under one
