...
``fl_dermamnist/results/centralised/`` and prints macro-F1
...
Usage:
    PYTHONPATH=. python fl_dermamnist/analysis/quick_centralised_summary.py
"""
...
CENTRAL_DIR = results_root() / "centralised"
