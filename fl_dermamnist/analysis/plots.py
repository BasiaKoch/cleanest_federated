...
Reads:
  ...
  - fl_dermamnist/results/partitions/partition_<mode>_seed<seed>_counts.csv
"""
...
def main():
    ...
    ap.add_argument("--results-dir", default="fl_dermamnist/results/headline")
    ap.add_argument("--E", type=int, default=20)
    ap.add_argument("--partition-counts",
                    default="fl_dermamnist/results/partitions/partition_medical_skew_7_clients_seed42_counts.csv",
