...
Usage
-----
    PYTHONPATH=. python -m fl_dermamnist.results.thesis_ready.scripts.analyse_statistical_heterogeneity

(or directly: python fl_dermamnist/results/thesis_ready/scripts/analyse_statistical_heterogeneity.py)
"""
