...
#   bash fl_dermamnist/scripts/hpc_mu_sweep_rescue.sh
#   squeue -u $USER
set -euo pipefail

REPO=/home/bk489/federated_clean/cleanest_federated
TPT="$REPO/fl_dermamnist/scripts/slurm_template_pytorch.sh"
...
echo "   python fl_dermamnist/scripts/check_mu_sweep.py"
echo "============================================================"
