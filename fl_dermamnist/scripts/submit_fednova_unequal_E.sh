...
# Usage
# -----
#   bash fl_dermamnist/scripts/submit_fednova_unequal_E.sh             # submit
#   DRY_RUN=1 bash fl_dermamnist/scripts/submit_fednova_unequal_E.sh   # print only
set -uo pipefail
...
FEDNOVA_TPL="$REPO_ROOT/fl_dermamnist/scripts/slurm_template_fednova.sh"
...
for i in "${!LEVELS[@]}"; do
    ...
    OUTDIR="fl_dermamnist/results/fednova_unequal_E/${LEVEL}_${PARTITION}"
...
echo "Outputs in:   fl_dermamnist/results/fednova_unequal_E/L{3,4}_*/"
echo ""
echo "After all 12 jobs finish, on the Mac run:"
echo "  python fl_dermamnist/results/thesis_ready/scripts/analyse_fednova_unequal_E.py"
