...
# Usage
# -----
#   bash fl_dermamnist/scripts/morning_submit_pytorch.sh
#   DRY_RUN=1 bash fl_dermamnist/scripts/morning_submit_pytorch.sh
set -uo pipefail

REPO_ROOT=/home/bk489/federated_clean/cleanest_federated
cd "$REPO_ROOT"

PYTORCH_TPL="$REPO_ROOT/fl_dermamnist/scripts/slurm_template_pytorch.sh"
DRY_RUN="${DRY_RUN:-0}"
...
echo "  python fl_dermamnist/results/thesis_ready/scripts/analyse_mu_sweep_ladder.py"
echo ""
