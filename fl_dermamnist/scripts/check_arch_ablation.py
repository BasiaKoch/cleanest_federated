...
BN_DIR = "fl_dermamnist/results/arch_ablation_bn"
GN_DIR = "fl_dermamnist/results/flower_C0_baseline"
...
def main():
    ...
    if not common:
        ...
        print("    bash fl_dermamnist/scripts/runpod_arch_ablation_bn.sh")
        return
