...
Idempotent. Re-run any time:
    python fl_dermamnist/scripts/check_mu_sweep.py
"""
...
MU_SWEEP_DIR  = "fl_dermamnist/results/mu_sweep"
HEADLINE_DIR  = "fl_dermamnist/results/headline"
...
def main():
    ...
    if not sweep_data:
        print(f"\n  (no μ-sweep data yet — run bash fl_dermamnist/scripts/hpc_mu_sweep.sh)")
