...
TFLW="$REPO/fl_dermamnist/scripts/slurm_template_flower.sh"
TSYS="$REPO/fl_dermamnist/scripts/slurm_template_system_het.sh"
TFNV="$REPO/fl_dermamnist/scripts/slurm_template_fednova.sh"
E=20
MU=0.01
...
echo "After completion, re-run: bash fl_dermamnist/scripts/check_results.sh"
