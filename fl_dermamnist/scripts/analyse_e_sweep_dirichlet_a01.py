...
DEFAULT_RESULTS_DIR = REPO_ROOT / "fl_dermamnist" / "results" / "e_sweep_dirichlet_a01"
DEFAULT_ANCHOR_DIR = REPO_ROOT / "fl_dermamnist" / "results" / "dirichlet_a01"
...
def main():
    ...
    if not runs:
        ...
        print("  MODE=pilot bash fl_dermamnist/scripts/submit_e_sweep_dirichlet_a01.sh")
        return
