...
from fl_dermamnist.data.partition import CLASS_NAMES, NUM_CLASSES


REPO_ROOT = Path(__file__).resolve().parents[2]
DEFAULT_RESULTS_DIR = REPO_ROOT / "fl_dermamnist" / "results" / "e_sweep"
DEFAULT_ANCHOR_DIR = REPO_ROOT / "fl_dermamnist" / "results" / "headline"
...
def main():
    ...
    if not runs:
        ...
        print("  MODE=pilot bash fl_dermamnist/scripts/submit_e_sweep.sh")
        return
