...
OUT_DIR=fl_dermamnist/results/class_weighted_baseline
...
echo "  fl_dermamnist/results/headline/                (FedAvg + plain CE)"
echo "  fl_dermamnist/results/headline/                (FedProx + plain CE)"
echo ""
echo "Analysis: PYTHONPATH=. python -m fl_dermamnist.analysis.tables \\"
