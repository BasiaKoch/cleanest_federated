...
#   tmux new -s archbn -d "bash fl_dermamnist/scripts/runpod_arch_ablation_bn.sh 2>&1 | tee /workspace/runpod_arch_ablation_bn_log.txt"
#
# Compare to the headline GN seeds with:
#   python fl_dermamnist/scripts/check_arch_ablation.py
set -uo pipefail
...
echo "   python fl_dermamnist/scripts/check_arch_ablation.py"
echo "============================================================"
