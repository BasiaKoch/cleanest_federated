...
#       MODE=pilot bash fl_dermamnist/scripts/submit_two_client_90_10_rare_stress.sh
#
#   PILOT-plus (seed 42 + one extra μ for cheap μ sensitivity):
#       MODE=pilot_mu bash fl_dermamnist/scripts/submit_two_client_90_10_rare_stress.sh
#
#   FULL (3 seeds × {FedAvg, FedProx} = 6 jobs):
#       MODE=full bash fl_dermamnist/scripts/submit_two_client_90_10_rare_stress.sh
#
#   FULL5 (5 seeds × {FedAvg, FedProx} = 10 jobs):
#       MODE=full5 bash fl_dermamnist/scripts/submit_two_client_90_10_rare_stress.sh
set -uo pipefail
...
echo "  PYTHONPATH=. python fl_dermamnist/scripts/analyse_two_client_90_10_rare_stress.py"
