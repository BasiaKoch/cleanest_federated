...
# Usage
# -----
#   bash fl_dermamnist/scripts/submit_fedprox_perfect_storm_L4.sh            # 9 jobs
#   DRY_RUN=1 bash fl_dermamnist/scripts/submit_fedprox_perfect_storm_L4.sh  # print only
set -uo pipefail
