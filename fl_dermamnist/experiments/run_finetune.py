...
Usage
-----
PYTHONPATH=. python -m fl_dermamnist.experiments.run_finetune \\
    --checkpoint fl_dermamnist/results/two_client_90_10_rare_stress/\\
                  best_state_fedavg_mu0.0_E20_s42.pt \\
    --partition two_client_90_10_rare_stress \\
    --client-id 1 --num-epochs 5 --lr 0.001 \\
    --seed 42 --device cuda \\
    --out-dir fl_dermamnist/results/small_hospital_finetune
"""
...
def main():
    ...
    ap.add_argument("--out-dir",
                    default="fl_dermamnist/results/small_hospital_finetune")
