...
Reads:
  - fl_dermamnist/results/headline/test_at_best_*_s{42,8675309}.json
      (existing pure-PyTorch results)
  - fl_dermamnist/results/headline_flower_verify/test_at_best_*_s{42,8675309}.json
...
Also writes a JSON summary at
  fl_dermamnist/results/thesis_ready/data/equivalence_full_scale.json
...
PT_DIR   = REPO / "fl_dermamnist/results/headline"
FL_DIR   = REPO / "fl_dermamnist/results/headline_flower_verify"
OUT_JSON = REPO / "fl_dermamnist/results/thesis_ready/data/equivalence_full_scale.json"
