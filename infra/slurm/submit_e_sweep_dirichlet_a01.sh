...
#       MODE=pilot bash infra/slurm/submit_e_sweep_dirichlet_a01.sh
#
#   FULL  (E∈{1,5,10,40} × 2 algos × 3 seeds = 24 jobs):
#       MODE=full bash infra/slurm/submit_e_sweep_dirichlet_a01.sh
#
#   FULL+ (also re-runs E=20 fresh in this dir instead of reusing dirichlet_a01/):
#       MODE=full_plus bash infra/slurm/submit_e_sweep_dirichlet_a01.sh
set -uo pipefail
...
echo "  PYTHONPATH=. python fl_dermamnist/analysis/analyse_e_sweep_dirichlet_a01.py"
