...
# Usage
# -----
#   bash infra/slurm/submit_li2020_asymmetric_L4.sh             # 12 jobs
#   DRY_RUN=1 bash infra/slurm/submit_li2020_asymmetric_L4.sh   # print only
set -uo pipefail
...
echo "  python fl_dermamnist/analysis/analyse_li2020_asymmetric_L4.py"
echo ""
