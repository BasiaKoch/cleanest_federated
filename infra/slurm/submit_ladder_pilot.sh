...
# Usage
# -----
#   bash infra/slurm/submit_ladder_pilot.sh             # submit
#   DRY_RUN=1 bash infra/slurm/submit_ladder_pilot.sh   # print only
#   SKIP_FEDNOVA=1 bash infra/slurm/submit_ladder_pilot.sh
set -uo pipefail
