...
# Usage
# -----
#   bash infra/slurm/submit_asymmetric_mu_L4.sh                   # submit 12 jobs
#   SKIP_CONTROL=1 bash infra/slurm/submit_asymmetric_mu_L4.sh    # 9 jobs (drop ctrl)
#   DRY_RUN=1 bash infra/slurm/submit_asymmetric_mu_L4.sh         # print only
set -uo pipefail
