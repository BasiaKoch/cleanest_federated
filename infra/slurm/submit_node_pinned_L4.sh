...
# Usage
# -----
#   bash infra/slurm/submit_node_pinned_L4.sh                        # default node gpu-q-13
#   NODELIST=gpu-q-40 bash infra/slurm/submit_node_pinned_L4.sh      # override node
#   DRY_RUN=1 bash infra/slurm/submit_node_pinned_L4.sh              # print only
#
