...
#
# Usage:
#   bash infra/local/pre_submission_check.sh
#
# What this checks
# ----------------
...
SUBMIT_SCRIPTS=( $(ls "$REPO_ROOT/infra/slurm/"submit_*.sh "$REPO_ROOT/infra/slurm/"slurm_template*.sh "$REPO_ROOT/infra/slurm/"slurm_centralised.sh 2>/dev/null) )
