...
\usepackage{graphicx}
\graphicspath{{fl_dermamnist/results/thesis_ready/figures/}}
\usepackage{booktabs}
...
preserved under
\path{cleanest_federated/fl_dermamnist/results/} with provenance manifests in
...
(Figure~\ref{fig:cond-confusion-d1}).
