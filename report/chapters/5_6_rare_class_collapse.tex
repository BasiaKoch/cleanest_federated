...
($n=3$ each; the corresponding melanoma F1, which adds the precision penalty,
is $2.28\,\%$, $10.82\,\%$, $36.74\,\%$) --- same disease, three detection
regimes spanning two orders of magnitude. Macro-F1 is structurally sensitive: each class enters with
