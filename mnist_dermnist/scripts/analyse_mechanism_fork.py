...
Usage:
    python -m mnist_dermnist.scripts.analyse_mechanism_fork \
        --results-root mnist_dermnist/results \
        --out mnist_dermnist/results/_mechanism_fork_summary
...
def main():
    ...
    ap.add_argument("--results-root", default="mnist_dermnist/results")
