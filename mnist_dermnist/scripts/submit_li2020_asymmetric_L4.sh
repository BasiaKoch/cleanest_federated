...
# Usage
# -----
#   bash mnist_dermnist/scripts/submit_li2020_asymmetric_L4.sh             # 12 jobs
#   DRY_RUN=1 bash mnist_dermnist/scripts/submit_li2020_asymmetric_L4.sh   # print only
set -uo pipefail
...
OUTDIR="mnist_dermnist/results/li2020_asymmetric_L4"
...
echo "  python mnist_dermnist/results/thesis_ready/scripts/analyse_li2020_asymmetric_L4.py"
echo ""
