...
from mnist_dermnist.data.partition import CLASS_NAMES


REPO_ROOT = Path(__file__).resolve().parents[2]
ENG_DIR = REPO_ROOT / "mnist_dermnist" / "results" / "two_client_90_10_rare_stress"
ESWEEP_DIR = REPO_ROOT / "mnist_dermnist" / "results" / "e_sweep"
HEADLINE_DIR = REPO_ROOT / "mnist_dermnist" / "results" / "headline"
OUT_DIR = REPO_ROOT / "mnist_dermnist" / "results" / "thesis_figures"
