...
# `mnist_dermnist/results/system_het_random_fednova/` to 10 paired seeds:
...
# (mnist_dermnist/fl/seeding.py, used by client_fednova.py). The script
...
#   bash mnist_dermnist/scripts/hpc_addendum_fednova_c2.sh
...
OUT="$REPO/mnist_dermnist/results/system_het_random_fednova"
E=20
...
if ! grep -q "numpy_legacy_seed" mnist_dermnist/fl_flower/client_fednova.py; then
...
echo "  python mnist_dermnist/scripts/check_system_het.py"
