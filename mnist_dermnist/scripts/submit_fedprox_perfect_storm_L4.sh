...
# Usage
# -----
#   bash mnist_dermnist/scripts/submit_fedprox_perfect_storm_L4.sh            # 9 jobs
#   DRY_RUN=1 bash mnist_dermnist/scripts/submit_fedprox_perfect_storm_L4.sh  # print only
set -uo pipefail
...
OUTDIR="mnist_dermnist/results/fedprox_perfect_storm_L4"
...
echo "  python mnist_dermnist/results/thesis_ready/scripts/analyse_fedprox_perfect_storm_L4.py"
echo ""
if [ ${#FAILED[@]} -ne 0 ]; then
