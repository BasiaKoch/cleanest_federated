...
#
# Args:
#   $1 = python module path (e.g. "mnist_dermnist.experiments.run_local_only")
#   $2 = extra args, passed verbatim to the python invocation
#
# Example (manual):
#   sbatch --job-name=mn_local_only_c1_s42 \
#     mnist_dermnist/scripts/slurm_template_single_process.sh \
...
#      --out-dir mnist_dermnist/results/small_hospital_local_only"
