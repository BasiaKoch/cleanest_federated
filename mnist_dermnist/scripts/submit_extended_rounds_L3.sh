...
# Usage
# -----
#   bash mnist_dermnist/scripts/submit_extended_rounds_L3.sh             # submit
#   DRY_RUN=1 bash mnist_dermnist/scripts/submit_extended_rounds_L3.sh   # print only
#
...
OUTDIR="mnist_dermnist/results/extended_rounds_L3"
