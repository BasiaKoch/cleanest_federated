...
``mnist_dermnist/results/two_client_90_10_rare_stress/`` and writes:
...
Usage:
    PYTHONPATH=. python mnist_dermnist/scripts/analyse_two_client_90_10_rare_stress.py
    PYTHONPATH=. python mnist_dermnist/scripts/analyse_two_client_90_10_rare_stress.py \
        --results-dir mnist_dermnist/results/two_client_90_10_rare_stress \
        --mu 0.01
"""
...
DEFAULT_RESULTS_DIR = REPO_ROOT / "mnist_dermnist" / "results" / "two_client_90_10_rare_stress"
