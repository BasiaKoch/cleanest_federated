...
BAD_LIST=(
    mnist_dermnist/results/iid/test_at_best_fedavg_mu0.0_E20_s8675309.json
    mnist_dermnist/results/iid/test_at_best_fedprox_mu0.01_E20_s8675309.json
    mnist_dermnist/results/dirichlet_a01/test_at_best_fedprox_mu0.01_E20_s8675309.json
    mnist_dermnist/results/specialist_partition/test_at_best_fedavg_mu0.0_E20_s8675309.json
    mnist_dermnist/results/specialist_partition/test_at_best_fedprox_mu0.01_E20_s8675309.json
    mnist_dermnist/results/system_het_fixed/test_at_best_fedprox_mu0.01_E20_sh-fixed_stragglers_s8675309.json
    mnist_dermnist/results/system_het_random/test_at_best_fedavg_mu0.0_E20_sh-random_stragglers_s8675309.json
)
...
run_flower fedavg  0.0  8675309 mnist_dermnist/results/flower_C0_baseline balanced_paired_7_clients uniform ""
run_flower fedprox 0.01 8675309 mnist_dermnist/results/flower_C0_baseline balanced_paired_7_clients uniform ""
run_flower fedprox 0.01 161803  mnist_dermnist/results/flower_C0_baseline balanced_paired_7_clients uniform ""
run_fednova            2024     mnist_dermnist/results/flower_C0_baseline balanced_paired_7_clients uniform ""
run_fednova            8675309  mnist_dermnist/results/flower_C0_baseline balanced_paired_7_clients uniform ""
run_fednova            161803   mnist_dermnist/results/flower_C0_baseline balanced_paired_7_clients uniform ""
...
run_flower fedprox 0.01 42      mnist_dermnist/results/system_het_fixed balanced_paired_7_clients fixed_stragglers "$EXTRA_C1"
run_flower fedprox 0.01 999     mnist_dermnist/results/system_het_fixed balanced_paired_7_clients fixed_stragglers "$EXTRA_C1"
run_flower fedprox 0.01 2024    mnist_dermnist/results/system_het_fixed balanced_paired_7_clients fixed_stragglers "$EXTRA_C1"
run_flower fedavg  0.0  8675309 mnist_dermnist/results/system_het_fixed balanced_paired_7_clients fixed_stragglers "$EXTRA_C1"
run_flower fedavg  0.0  161803  mnist_dermnist/results/system_het_fixed balanced_paired_7_clients fixed_stragglers "$EXTRA_C1"
run_flower fedprox 0.01 8675309 mnist_dermnist/results/system_het_fixed balanced_paired_7_clients fixed_stragglers "$EXTRA_C1"
...
run_flower fedavg  0.0  123     mnist_dermnist/results/system_het_random balanced_paired_7_clients random_stragglers "$EXTRA_C2"
run_flower fedprox 0.01 789     mnist_dermnist/results/system_het_random balanced_paired_7_clients random_stragglers "$EXTRA_C2"
run_flower fedavg  0.0  2024    mnist_dermnist/results/system_het_random balanced_paired_7_clients random_stragglers "$EXTRA_C2"
run_flower fedprox 0.01 8675309 mnist_dermnist/results/system_het_random balanced_paired_7_clients random_stragglers "$EXTRA_C2"
run_flower fedprox 0.01 161803  mnist_dermnist/results/system_het_random balanced_paired_7_clients random_stragglers "$EXTRA_C2"
run_flower fedavg  0.0  8675309 mnist_dermnist/results/system_het_random balanced_paired_7_clients random_stragglers "$EXTRA_C2"
...
# iid (2 jobs)
run_flower fedavg  0.0  8675309 mnist_dermnist/results/iid                  iid_7_clients               uniform ""
run_flower fedprox 0.01 8675309 mnist_dermnist/results/iid                  iid_7_clients               uniform ""
# dirichlet_alpha01 (1 job — fedavg s8675309 is already valid on disk)
run_flower fedprox 0.01 8675309 mnist_dermnist/results/dirichlet_a01        dirichlet_alpha01_7_clients uniform ""
# specialist (2 jobs)
run_flower fedavg  0.0  8675309 mnist_dermnist/results/specialist_partition specialist_7_clients        uniform ""
run_flower fedprox 0.01 8675309 mnist_dermnist/results/specialist_partition specialist_7_clients        uniform ""
...
echo "   ls mnist_dermnist/results/iid/test_at_best_*.json                    | wc -l   # expect 20"
echo "   ls mnist_dermnist/results/dirichlet_a01/test_at_best_*.json          | wc -l   # expect 20"
echo "   ls mnist_dermnist/results/specialist_partition/test_at_best_*.json   | wc -l   # expect 20"
echo "   ls mnist_dermnist/results/system_het_random_fednova/test_at_best_*.json | wc -l  # expect 8 (FedNova C2 documented as failure mode)"
echo "============================================================"
