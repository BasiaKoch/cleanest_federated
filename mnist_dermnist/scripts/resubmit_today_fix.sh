...
sbatch "$TFLW" fedavg 0.0 123 20 mnist_dermnist/results/mu_sweep balanced_paired_7_clients ; sleep 3
sbatch "$TFLW" fedavg 0.0 456 20 mnist_dermnist/results/mu_sweep balanced_paired_7_clients ; sleep 3
