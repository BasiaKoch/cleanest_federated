...
#
# Outputs go to mnist_dermnist/results/arch_ablation_bn/ — a separate
...
#   bash mnist_dermnist/scripts/hpc_arch_ablation_bn.sh
...
if ! grep -q -- "--model-variant" mnist_dermnist/experiments/run_one_flower.py; then
