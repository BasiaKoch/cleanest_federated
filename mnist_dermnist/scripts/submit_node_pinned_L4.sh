...
# Usage
# -----
#   bash mnist_dermnist/scripts/submit_node_pinned_L4.sh                        # default node gpu-q-13
#   NODELIST=gpu-q-40 bash mnist_dermnist/scripts/submit_node_pinned_L4.sh      # override node
#   DRY_RUN=1 bash mnist_dermnist/scripts/submit_node_pinned_L4.sh              # print only
#
...
OUTDIR="mnist_dermnist/results/node_pinned_L4"
