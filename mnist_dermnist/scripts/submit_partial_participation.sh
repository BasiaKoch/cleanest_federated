...
#
# Output: mnist_dermnist/results/system_het_partial_C0.5/
...
OUT_DIR=mnist_dermnist/results/system_het_partial_C0.5
...
echo "  mnist_dermnist/results/flower_C0_baseline/"
