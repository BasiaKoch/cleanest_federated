...
#       MODE=pilot bash mnist_dermnist/scripts/submit_two_client_90_10_rare_stress.sh
#
#   PILOT-plus (seed 42 + one extra μ for cheap μ sensitivity):
#       MODE=pilot_mu bash mnist_dermnist/scripts/submit_two_client_90_10_rare_stress.sh
#
#   FULL (3 seeds × {FedAvg, FedProx} = 6 jobs):
#       MODE=full bash mnist_dermnist/scripts/submit_two_client_90_10_rare_stress.sh
#
#   FULL5 (5 seeds × {FedAvg, FedProx} = 10 jobs):
#       MODE=full5 bash mnist_dermnist/scripts/submit_two_client_90_10_rare_stress.sh
set -uo pipefail
...
OUT_DIR=mnist_dermnist/results/two_client_90_10_rare_stress
...
echo "  PYTHONPATH=. python mnist_dermnist/scripts/analyse_two_client_90_10_rare_stress.py"
