...
# Usage
# -----
#   bash mnist_dermnist/scripts/morning_submit_pytorch.sh
#   DRY_RUN=1 bash mnist_dermnist/scripts/morning_submit_pytorch.sh
set -uo pipefail

REPO_ROOT=/home/bk489/federated_clean/cleanest_federated
cd "$REPO_ROOT"

PYTORCH_TPL="$REPO_ROOT/mnist_dermnist/scripts/slurm_template_pytorch.sh"
DRY_RUN="${DRY_RUN:-0}"
...
for seed in 42 123 456; do
    submit fedavg  0.0       "$seed" 150 \
        ...
        "mnist_dermnist/results/node_pinned_L4" \
...
for seed in 42 123 456; do
    submit fedavg  0.0       "$seed" 250 \
        ...
        "mnist_dermnist/results/extended_rounds_L3" \
...
for level in L0 L2 L4; do
    ...
    out_dir="mnist_dermnist/results/mu_sweep_ladder/${level}_${partition}"
...
for seed in 42 123 456; do
    submit fedavg  0.0       "$seed" 150 \
        "two_client_90_10_rare_stress" \
        "mnist_dermnist/results/two_client_90_10_rare_stress" \
...
echo "  python mnist_dermnist/results/thesis_ready/scripts/analyse_node_pinned_L4.py"
echo "  python mnist_dermnist/results/thesis_ready/scripts/analyse_extended_rounds_L3.py"
echo "  python mnist_dermnist/results/thesis_ready/scripts/analyse_mu_sweep_ladder.py"
echo ""
