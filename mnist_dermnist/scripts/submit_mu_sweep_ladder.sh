...
# Usage
# -----
#   bash mnist_dermnist/scripts/submit_mu_sweep_ladder.sh            # submit
#   DRY_RUN=1 bash mnist_dermnist/scripts/submit_mu_sweep_ladder.sh  # print only
set -uo pipefail
...
for i in "${!LEVELS[@]}"; do
    ...
    OUTDIR="mnist_dermnist/results/mu_sweep_ladder/L${LEVEL}_${PARTITION}"
...
echo "Outputs in:   mnist_dermnist/results/mu_sweep_ladder/L<level>_<partition>/"
echo ""
