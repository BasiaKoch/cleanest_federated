...
Usage:
    python -m mnist_dermnist.analysis.amplification \\
        --dir mnist_dermnist/results/system_het_random_fednova \\
        --out mnist_dermnist/results/system_het_random_fednova/analysis/amplification \\
