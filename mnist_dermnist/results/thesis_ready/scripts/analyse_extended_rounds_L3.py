...
Reads the 6 runs at
  mnist_dermnist/results/extended_rounds_L3/test_at_best_{fedavg,fedprox}_mu*_E20_s{42,123,456}.json
and compares them to the original 150-round L3 single-seed run at
  mnist_dermnist/results/heterogeneity_ladder/L3_two_client_70_30_rare_enriched/
...
IN_DIR = REPO_ROOT / "mnist_dermnist/results/extended_rounds_L3"
ORIG_DIR = REPO_ROOT / "mnist_dermnist/results/heterogeneity_ladder/L3_two_client_70_30_rare_enriched"
