...
Usage
-----
    PYTHONPATH=. python -m mnist_dermnist.results.thesis_ready.scripts.analyse_statistical_heterogeneity

(or directly: python mnist_dermnist/results/thesis_ready/scripts/analyse_statistical_heterogeneity.py)
"""
