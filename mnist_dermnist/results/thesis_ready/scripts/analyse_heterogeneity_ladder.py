...
Reads results from ``mnist_dermnist/results/heterogeneity_ladder/`` and
...
Expected layout
---------------
  mnist_dermnist/results/heterogeneity_ladder/
...
Run
---
PYTHONPATH=. python3 -m mnist_dermnist.results.thesis_ready.scripts.analyse_heterogeneity_ladder
"""
