...
OUT = REPO_ROOT / "mnist_dermnist" / "results" / "thesis_ready" / "figures"
OUT.mkdir(parents=True, exist_ok=True)


# --- Load all five configurations -----------------------------------
PATHS = {
    "Client 0 alone":  REPO_ROOT / "mnist_dermnist/results/small_hospital_local_only/test_at_best_local_only_c0_E3000_s42.json",
    "Client 1 alone":  REPO_ROOT / "mnist_dermnist/results/small_hospital_local_only/test_at_best_local_only_c1_E3000_s42.json",
    "FedAvg":          REPO_ROOT / "mnist_dermnist/results/two_client_90_10_rare_stress/test_at_best_fedavg_mu0.0_E20_s42.json",
    r"FedProx ($\mu=0.01$)": REPO_ROOT / "mnist_dermnist/results/two_client_90_10_rare_stress/test_at_best_fedprox_mu0.01_E20_s42.json",
    "Centralised":     REPO_ROOT / "mnist_dermnist/results/centralised/centralised_seed42.json",
}
