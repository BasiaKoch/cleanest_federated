...
\begin{figure}[h]
\centering
\includegraphics[width=0.85\textwidth]{F_val_curves_l4_four_condition.pdf}
\caption{Four-condition validation trajectories at L4, mean over $n=3$ seeds.
FedAvg+drop and FedProx+drop overlap throughout 150 rounds, isolating the
proximal term as inactive under matched drop-handling.
FedProx+$\gamma$-inexact diverges upward around round 30 and stabilises
near $0.48$. Perfect-storm trajectories (90\% random stragglers) are in
Appendix~C.}
