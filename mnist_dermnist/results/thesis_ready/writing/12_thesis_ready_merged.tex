...
This chapter reports the empirical findings of the two heterogeneity experiments. Section~\ref{sec:results-statistical-het} reports the statistical-heterogeneity arm: FedProx-vs-FedAvg paired comparison across four partition designs (engineered, IID, Dirichlet $\alpha = 0.1$, specialist), the cross-runtime sensitivity check, and the centralised-reference federation tax. Section~\ref{sec:results-system-het} reports the system-heterogeneity arm: paired comparisons under three straggler conditions, an asymmetric-protocol decomposition that separates the proximal regulariser's contribution from the partial-work-inclusion effect, and an exploratory FedNova comparison.
...
\subsubsection{Experimental design and partition motivation}
...
\subsubsection{Primary analysis: headline paired comparison}
...
\subsubsection{Robustness across partition designs}
...
\subsubsection{Cross-runtime sensitivity}
...
\subsubsection{Summary and limitations of the statistical-heterogeneity arm}
...
\subsubsection{Experimental design and condition motivation}
...
\subsubsection{Primary analysis: headline paired comparisons}
...
\subsubsection{Asymmetric straggler protocol and effect decomposition}
...
\subsubsection{Exploratory FedNova comparison}
\label{sec:fednova}
...
\subsubsection{Straggler-tolerance ratios}
\label{sec:tolerance}
...
\subsubsection{Schedule sanity verification}
...
\subsubsection{Summary and limitations of the system-heterogeneity arm}
