...
\begin{table}[h]
\centering
\caption{Robustness across partition regimes (10 paired seeds each;
results pending HPC completion).}
...
\midrule
Centralised (upper bound)         & \multicolumn{2}{c}{[pending HPC]} & --- & --- \\
...
\texttt{balanced\_paired\_7\_clients} (this work) & $0.481 \pm 0.025$ & $0.508 \pm 0.014$ & $+0.027$ & $0.020$ \\
\bottomrule
\end{tabular}
\end{table}
