...
budgets as ``system heterogeneity'' following \citet{Li et al., 2020};
...
\citet{Li et al., 2020} §5.2, where FedAvg \emph{drops} straggler
...
\citet{Li et al., 2020} §5.2 protocol up to the aggregation deviation
...
inspired by \citet{Marija, 2025} §3.8.4 but carries an
experimental-design caveat that we make explicit here. In the
