...
⁵ §3.6 update-norm diagnostics (`F_update_norms.pdf`): logs available for **FedAvg n=9, FedProx n=8, FedNova n=7** (not all 10 seeds); the reported means reproduce from the available logs.
