...
## Project Status
The project is complete and ready for submission. All experiments, analyses, the report, and the executive summary are finalised; the saved results and provenance allow the reported tables and figures to be reproduced without retraining.
